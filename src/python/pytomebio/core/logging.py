...
def setup_logging(level: str = "INFO") -> None:
    """Globally configure logging for all modules under PYTOMEBIO.
    ...
    """
    global __PYTOMEBIO_LOGGING_SETUP

    with __LOCK:
        if not __PYTOMEBIO_LOGGING_SETUP:
            format = (
